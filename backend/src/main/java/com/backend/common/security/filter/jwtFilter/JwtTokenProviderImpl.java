package com.backend.common.security.filter.jwtFilter;
...
import com.backend.common.security.filter.jwtFilter.JwtDTO.AccessAndRefreshTokenResponse;
import com.backend.common.security.filter.jwtFilter.JwtDTO.AccessTokenResponse;
import com.backend.common.util.responseWriter.ResponseWriter;
import com.backend.domains.member.domain.Member;
import com.backend.domains.member.domain.RefreshToken;
...
public class JwtTokenProviderImpl implements JwtTokenProvider {
	...
	public Authentication getAuthentication(String accessToken) {
		...
		return UsernamePasswordAuthenticationToken.authenticated(memberId, "", authorities);
	}
