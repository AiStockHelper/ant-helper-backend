package kakaobootcamp.backend.kis.kis_client.config;
...
import com.backend.domains.member.enums.AccountType;
...
public class Configuration {
    ...
    public Configuration(AccountType accountType) {
        // 모의투자와 실전투자에 따라 HTTP 호스트 주소를 설정
        if (accountType == AccountType.PAPER_TRADE) {
            this.httpHost =  "https://openapivts.koreainvestment.com:29443";
        } else {
            this.httpHost =  "https://openapi.koreainvestment.com:9443";
        }
    }
